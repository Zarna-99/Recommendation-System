...
def display_books(popular_data):
    ...
    for i in range(num_rows):
        ...
        st.markdown("<h5 style='text-align: left;'>_______________________________________________________________________________________________________________________________</h5>",
